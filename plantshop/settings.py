...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Misalkan ini adalah folder yang digunakan saat collectstatic
...
CSRF_TRUSTED_ORIGINS = ["http://localhost","http://127.0.0.1","http://nelil-amaani-plantshop.pbp.cs.ui.ac.id", "https://nelil-amaani-plantshop.pbp.cs.ui.ac.id"]